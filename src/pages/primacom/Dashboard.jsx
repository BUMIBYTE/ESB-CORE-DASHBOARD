...
const DashboardPrimacom = ({ipAddress}) => {
  ...
  const fetchData = async () => {
    try {
      const [cpuRes, memRes, serverRes,storageRes, jobRes] = await Promise.all([
        axios.get(`${ipAddress}/primacom/cpu`),
        axios.get(`${ipAddress}/primacom/memory`),
        axios.get(`${ipAddress}/primacom/servers`),
        axios.get(`${ipAddress}/primacom/storage`),
        axios.get(`${ipAddress}/jbang/jobs`)
      ]);
...
export default DashboardPrimacom;